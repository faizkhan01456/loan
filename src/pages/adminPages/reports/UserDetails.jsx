  ...
  const UserDetails = () => {
    ...
    const [loanData] = useState([
      { id: 1, name: "Rahul Sharma", email: "rahul@example.com", mobile: "9876543210", loanType: "Home Loan", city: "Mumbai", state: "MH" },
      { id: 2, name: "Anjali Gupta", email: "anjali@example.com", mobile: "9988776655", loanType: "Personal Loan", city: "Delhi", state: "DL" },
      { id: 3, name: "Amit Patel", email: "amit@example.com", mobile: "9123456789", loanType: "Car Loan", city: "Surat", state: "GJ" },
      { id: 4, name: "Sana Khan", email: "sana@example.com", mobile: "8877665544", loanType: "Business Loan", city: "Lucknow", state: "UP" },
      { id: 5, name: "Vikram Singh", email: "vikram@example.com", mobile: "7766554433", loanType: "Home Loan", city: "Jaipur", state: "RJ" },
      { id: 6, name: "Priya Rai", email: "priya@example.com", mobile: "9000011111", loanType: "Education Loan", city: "Pune", state: "MH" },
      { id: 7, name: "Rohan Das", email: "rohan@example.com", mobile: "9222233333", loanType: "Personal Loan", city: "Kolkata", state: "WB" },
    ]);
    ...
    const getLoanTypeColor = (type) => {
      const colors = {
        'Home Loan': 'bg-blue-50 text-blue-700 border-blue-200',
        'Personal Loan': 'bg-purple-50 text-purple-700 border-purple-200',
        'Car Loan': 'bg-green-50 text-green-700 border-green-200',
        'Business Loan': 'bg-amber-50 text-amber-700 border-amber-200',
        'Education Loan': 'bg-indigo-50 text-indigo-700 border-indigo-200'
      };
                      ...
                      <td className="px-8 py-5">
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-900 font-medium">{item.mobile}</span>
                          </div>
                          <a
